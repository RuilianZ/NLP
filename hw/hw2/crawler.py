...
def add_3(input_df):
    input_df['body_clean'] = input_df['body'].apply(clean_text)
    input_df['body_sw'] = input_df['body_clean'].apply(rem_sw)
    input_df['body_sw_stem'] = input_df['body_sw'].apply(my_stem)
    return input_df
